...
const projects = [
  {
    ...
    description:
      "Full-stack application predicting symptoms using NLP and wearable data. Used BERT (HuggingFace) for symptom extraction from user input, integrated real-time health monitoring API with 90% model accuracy, and developed interactive chatbot for diagnostics.",
    image: project1,
  ...
  },
  {
    ...
    description:
      "ML project predicting optimal crops based on soil & weather data. Trained Random Forest & SVM models achieving 90%+ accuracy, used EDA and visualizations to analyze feature impact, and applied hyperparameter tuning for performance optimization.",
    image: project2,
  ...
  },
  {
    ...
    description:
      "Responsive e-commerce platform with real-time cart & search functionality. Built secure login, payment system, and admin dashboard. Developed REST APIs with Django consumed via dynamic frontend with separate admin and customer interfaces.",
    image: project3,
  ...
  },
  {
    ...
    description:
      "A modern web app for generating professional bills & invoices instantly. Designed with simplicity and efficiency in mind, featuring exportable invoices and smooth deployment. Optimized for performance with responsive UI on all devices.",
    image: null, // No image
